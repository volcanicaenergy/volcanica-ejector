...
st.title("📱 Ejector Sizing Tool (Mobile)")

st.markdown("Add multiple **motive** and **suction** streams with custom inputs. Oil and Water are in BPD, Gas in MMSCFD.")
...
if st.button("Calculate"):
    ...
    if total_mass_flow > 0 and rho_list:
        ...
        avg_velocity = 125  # ft/s assumption
